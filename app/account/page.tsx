  ...
  if (authLoading) {
    return (
      <div className="flex min-h-screen items-center justify-center" style={{ background: "var(--background)" }}>
        <p className="animate-pulse text-sm" style={{ color: "var(--text-muted)" }}>Loading…</p>
      </div>
    );
  }
  if (!user) return null;
      ...
      <div className="mx-auto max-w-lg px-4 py-10">
        ...
        >
          ...
          {isEmailUser ? (
            <form onSubmit={handleChangePassword} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  onFocus={(e) => (e.currentTarget.style.borderColor = "var(--ygo-accent)")}
              ...
              {status && (
                <p
                  ...
                  style={{
                    ...
                    color: status.type === "success" ? "var(--price-color)" : "var(--primary-red)",
            ...
            >
              Your account uses{" "}
              <span style={{ color: "var(--pkmn-accent)" }}>Google Sign-In</span>. Password
