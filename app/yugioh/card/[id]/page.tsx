  ...
  return (
    <div style={{ background: "#080B14", minHeight: "100vh" }}>
      <div className="max-w-screen-lg mx-auto px-4 py-8">
        ...
        <BackButton
          label={from === "/" ? "Back to Home" : from?.startsWith("/search") ? "Back to Search Results" : from?.startsWith("/yugioh/sets/") ? "Back to Set" : card.type.includes("Spell") ? "Back to Spell Cards" : card.type.includes("Trap") ? "Back to Trap Cards" : "Back to Monster Cards"}
