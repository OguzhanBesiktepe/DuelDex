...
export default function CardImageZoom({ images, alt, width = 240 }: CardImageZoomProps) {
    ...
    <>
      ...
      <div className="detail-float-wrapper flex flex-col items-center gap-3">
        ...
        <img
          ...
          style={{ width, height: "auto", boxShadow: "0 28px 56px rgba(0,0,0,0.7)", cursor: "zoom-in" }}
        ...
        {total > 1 && (
          <div className="flex items-center gap-3">
            <button
              ...
              style={{ background: "#0E1220", border: "1px solid #1A2035", color: "#7A8BA8" }}
        ...
        >
          ...
          {total > 1 && (
            <button
              ...
              style={{ background: "#0E1220", border: "1px solid #1A2035", color: "#F0F2FF" }}
          ...
          {total > 1 && (
            <p className="absolute bottom-6 text-xs" style={{ color: "#7A8BA8" }}>
